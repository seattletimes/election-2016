module.exports = function(grunt) {
  ...
  grunt.registerTask("pull", "Grab/process election data", ["sheets", "elex", "content", "scrape"]);
  grunt.registerTask("template", "Build HTML from content/templates", ["elex", "content", "scrape", "build"]);
